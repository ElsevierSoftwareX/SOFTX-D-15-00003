...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-v\n-v2\n-f\n-s\n-n\n-eig\n-eig2\n-comp\n-rmsf\n-proj\n-2d\n-3d\n-filt\n-extr\n-over\n-inpr\n-nice\n-b\n-e\n-dt\n-tu\n-w\n-xvg\n-first\n-last\n-skip\n-max\n-nframes\n-split\n-entropy\n-temp\n-nevskip' -- $c)); return 0; fi
case "$p" in
-v) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-v2) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-filt) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-extr) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
case "$p" in
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-f2) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-s1) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-s2) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-c) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa|.gro|.g96|.pdb|.brk|.ent)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
case "$p" in
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-cl) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-tu) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -W $'fs\nps\nns\nus\nms\ns' -- $c));;
-xvg) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -W $'xmgrace\nxmgr\nnone' -- $c));;
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-f1\n-f2\n-o\n-n1\n-n2\n-no\n-nice\n-w\n-one\n-nomw\n-pbc\n-nofit\n-name\n-label\n-bfac' -- $c)); return 0; fi
case "$p" in
-f1) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa|.gro|.g96|.pdb|.brk|.ent)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-f2) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
case "$p" in
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-e) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.edr?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_covar_compl() {
local IFS=$'\n'
local c=${COMP_WORDS[COMP_CWORD]}
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-en\n-f\n-s\n-n\n-o\n-eps\n-a\n-d\n-c\n-g\n-adip\n-dip3d\n-cos\n-cmap\n-slab\n-nice\n-b\n-e\n-dt\n-w\n-xvg\n-mu\n-mumax\n-epsilonRF\n-skip\n-temp\n-corr\n-nopairs\n-quad\n-ncos\n-axis\n-sl\n-gkratom\n-gkratom2\n-rcmax\n-phi\n-nlevels\n-ndegrees\n-acflen\n-nonormalize\n-P\n-fitfn\n-beginfit\n-endfit' -- $c)); return 0; fi
case "$p" in
...
case "$p" in
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.pdb?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_editconf_compl() {
local IFS=$'\n'
...
case "$p" in
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa|.gro|.g96|.pdb|.brk|.ent)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-ol) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-oh) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
...
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-trj) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_genion_compl() {
local IFS=$'\n'
local c=${COMP_WORDS[COMP_CWORD]}
...
-c) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-r) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-rb) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-p) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.top?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-pp) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.top?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-t) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-e) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.edr?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-imd) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.gro?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-ref) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_gyrate_compl() {
local IFS=$'\n'
local c=${COMP_WORDS[COMP_CWORD]}
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-f\n-ci\n-ip\n-o\n-nice\n-box\n-nmol\n-try\n-seed\n-radius\n-scale\n-dr\n-rot\n-allpair' -- $c)); return 0; fi
case "$p" in
-f) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-ci) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa|.gro|.g96|.pdb|.brk|.ent)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-tar) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-ori) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
case "$p" in
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-rerun) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
-ox) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-f1\n-f2\n-o\n-or\n-n\n-nice\n-w\n-xvg\n-ninterm\n-first\n-last\n-nofit' -- $c)); return 0; fi
case "$p" in
-f1) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-f2) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-or) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-xvg) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -W $'xmgrace\nxmgr\nnone' -- $c));;
esac }
...
-s) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.out?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-so) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_polystat_compl() {
local IFS=$'\n'
local c=${COMP_WORDS[COMP_CWORD]}
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-o\n-nice\n-w\n-xvg\n-c6\n-cn\n-pow\n-sig\n-eps\n-A\n-B\n-C\n-qi\n-qj\n-sigfac' -- $c)); return 0; fi
case "$p" in
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-xvg) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -W $'xmgrace\nxmgr\nnone' -- $c));;
esac }
...
case "$p" in
-cp) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-cs) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp|.tpr|.tpb|.tpa)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.gro|.g96|.pdb|.brk|.ent|.esp)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-p) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.top?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
esac }
_gmx_sorient_compl() {
...
-oxt) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-ov) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-of) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-f\n-o\n-n\n-demux\n-nice\n-tu\n-xvg\n-b\n-e\n-dt\n-novel\n-settime\n-nosort\n-keeplast\n-overwrite\n-cat' -- $c)); return 0; fi
case "$p" in
-f) COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.cpt|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-o) COMPREPLY=( $(compgen -S ' ' -X '!*@(.xtc|.trr|.trj|.gro|.g96|.pdb|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-n) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-p\n-err\n-so\n-s\n-o\n-x\n-cpi\n-cpo\n-c\n-e\n-g\n-dhdl\n-field\n-table\n-tabletf\n-tablep\n-tableb\n-rerun\n-tpi\n-tpid\n-ei\n-eo\n-devout\n-runav\n-px\n-pf\n-ro\n-ra\n-rs\n-rt\n-mtx\n-dn\n-swap\n-bo\n-bx\n-bcpo\n-bc\n-be\n-bg\n-beo\n-bdhdl\n-bfield\n-btpi\n-btpid\n-bdevout\n-brunav\n-bpx\n-bpf\n-bro\n-bra\n-brs\n-brt\n-bmtx\n-bdn\n-bswap\n-nice\n-xvg\n-np\n-npstring\n-ntmpi\n-r\n-max\n-min\n-npme\n-fix\n-rmax\n-rmin\n-noscalevdw\n-ntpr\n-steps\n-resetstep\n-nsteps\n-launch\n-nobench\n-nocheck\n-noappend\n-cpnum' -- $c)); return 0; fi
case "$p" in
...
-dn) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.ndx?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-swap) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*.xvg?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
-bo) (( $n <= 1 )) && COMPREPLY=( $(compgen -S ' ' -X '!*@(.trr|.cpt|.trj|.tng)?(.gz|.Z)' -f -- $c ; compgen -S '/' -d $c));;
...
local p=${COMP_WORDS[COMP_CWORD-n]}
COMPREPLY=()
if (( $COMP_CWORD <= 1 )) || [[ $c == -* ]]; then COMPREPLY=( $(compgen -S ' '  -W $'-ix\n-if\n-it\n-ip\n-is\n-o\n-hist\n-oiact\n-iiact\n-bsres\n-bsprof\n-tab\n-nice\n-xvg\n-min\n-max\n-noauto\n-bins\n-temp\n-tol\n-v\n-b\n-e\n-dt\n-histonly\n-boundsonly\n-nolog\n-unit\n-zprof0\n-cycl\n-sym\n-ac\n-acsig\n-ac-trestart\n-nBootstrap\n-bs-method\n-bs-tau\n-bs-seed\n-histbs-block\n-vbs' -- $c)); return 0; fi
case "$p" in
...
convert-tpr) _gmx_convert-tpr_compl ;;
...
insert-molecules) _gmx_insert-molecules_compl ;;
lie) _gmx_lie_compl ;;
...
protonate) _gmx_protonate_compl ;;
